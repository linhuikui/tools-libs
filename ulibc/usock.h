...
*server : bind
*clicent : connect
*@param host like tcp udp "127.0.0.1" or unix "@test" 
*@param service like tcp udp "9100" "snmp" "tftp" or NULL
*@param maxconn max clients the server will listen
*return cosket fd or < 0
*/
